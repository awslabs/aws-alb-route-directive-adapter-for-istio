...
// process data associated with the 'authzadaptor' template.
//
...
type HandlerBuilder interface {
	...
	SetAuthzadaptorTypes(map[string]*Type /*Instance name -> Type*/)
}
...
// at configuration time via the method 'SetAuthzadaptorTypes'.
